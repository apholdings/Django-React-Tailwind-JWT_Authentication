...
function Header({
  ...
  const authLinks = (
    ...
    <a onClick={logoutHandler}
      href='#!' className="text-base font-medium text-gray-500 hover:text-gray-900">
      Logout
    </a>
    <Link
      to="/dashboard"
      className="ml-8 inline-flex items-center justify-center px-4 py-1 border border-transparent rounded-full shadow-sm text-base font-medium text-white bg-blue-500 hover:bg-blue-600"
    >
      Dashboard
    </Link>
  </Fragment>
  ...
  const mobileAuthLinks = (
    <Fragment>
      ...
      <p className="mt-6 text-center text-base font-medium text-gray-500">
        Existing customer?{' '}
        <a onClick={logoutHandler}
          href='#!' className="text-blue-600 hover:text-blue-500">
          Logout
        </a>
      </p>
    </Fragment>
